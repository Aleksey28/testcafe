...
gulp.step('test-functional-travis-desktop-osx-run', () => {
    return testFunctional(TESTS_GLOB, functionalTestConfig.testingEnvironmentNames.osXDesktopAndMSEdgeBrowsers);
});

gulp.task('test-functional-travis-desktop-osx', gulp.series('prepare-tests', 'test-functional-travis-desktop-osx-run'));
...
gulp.task('test-functional-local-safari', gulp.series('test-functional-local-safari-before-run', 'test-functional-local-safari-run', 'test-functional-local-safari-after-run'));
