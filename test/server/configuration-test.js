...
describe('TypeScriptConfiguration', function () {
    ...
    it('Configuration file does not exist', async () => {
        ...
        expect(message).eql(`"${nonExistingConfiguration.defaultPaths[TestCafeConfiguration.PRIORITY_EXTENSIONS.js]}" does not contain a TypeScript configuration file.`);
    });
